...
function onCoinBalance(coins, transferableCoins)
	...
	setStringColor(coinTooltip, "Total Nyxos Coins: " .. comma_value(coins + transferableCoins), "#3f3f3f")
	setStringColor(coinTooltip, " �", "#f7e6fe")
	setStringColor(coinTooltip, "\nIncluded transferable Nyxos Coins: " .. comma_value(transferableCoins), "#3f3f3f")
	setStringColor(coinTooltip, " �", "#f7e6fe")
