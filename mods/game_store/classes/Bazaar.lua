...
function Bazaar:openConfirmation()
	...
	Bazaar.initialFee ..
	'<img src="/images/store/icon-tibiacointransferable" width="12" height="12" offset="0 2" /> becomes due which will be deducted from your account\'s<p>Nyxos Coins balance. Further, 8% of the auction\'s sales revenue will be kept by Nyxos as commission.</p>'
	...
	local secondLabel =
	'  Important: Note that the Nyxos Coins you receive for selling your character may be partly or completely non-transferable up to 120 days after the auction has ended. Non-transferable Nyxos Coins cannot be sold in the Market or gifted to other accounts.\n'
