...
function HomeOffer:configure(categoryName, offers, scrolling, homePanel, reasons, dailyOfferPrice, dailyOffers)
	...
	rerollButton:setTooltip(string.format("Reroll offers for %d Nyxos Coins", dailyOfferPrice))
end
...
function HomeOffer:onRerollDailyOffer(button)
	...
	local message = string.format("Are you sure you want to reroll the daily offer for %d Nyxos Coins?",
