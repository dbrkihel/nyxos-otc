...
-- set to the latest Nyxos.pic signature to make otclient compatible with official Nyxos
...
ControlButtonTooltips = {
  ...
  ["cyclopediaDialog"] = "%s Nyxos Cyclopedia",
  ...
  ["manageShortcuts"] = "%s Manage Shortcuts",
