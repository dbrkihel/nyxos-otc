...
function init()
  ...
  -- did nothing. Install the sender over the noop: crystalserver/nyxos
...
function onGameStart()
  ...
  -- open Nyxos has delay in auto walking
...
function tryLogout(prompt)
  ...
  if not g_game.isConnectionOk() then
    ...
    msg = 'Are you sure you want to leave Nyxos?'
...
function createThingMenu(tile, menuPosition, lookThing, useThing, creatureThing)
  ...
  if useThing then
    ...
    local podiumIds = {RENOWN_PODIUM, LEGACY_RENOWN_PODIUM, VIGOUR_PODIUM, TENACITY_PODIUM, NYXOS_MONSTER_PODIUM}
    ...
    if isPodium then
      menu:addOption(tr('Customise Podium'),
        function()
          if useThing:getId() == VIGOUR_PODIUM or useThing:getId() == TENACITY_PODIUM or useThing:getId() == NYXOS_MONSTER_PODIUM then
