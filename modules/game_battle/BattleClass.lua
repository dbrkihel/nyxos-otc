...
function BattleClass:create()
	return setmetatable({
	secondary = false,
	-- Mesma fonte de verdade do painel: evita que o estado salvo e o estado
	-- inicial da instancia discordem.
	showFilters = not isHidingFilters(),
	panel = nil,
	filterPanel = nil,
...
function BattleClass:configure(windowId, window)
  ...
  -- Precisa vir depois de filterPanel/toggleFilterButton estarem atribuidos e
  -- depois do minimo padrao: hideFilterPanel baixa o minimo para 56, e na ordem
  -- inversa o setContentMinimumHeight(86) acima desfazia o ajuste.
  if isHidingFilters() then
    hideFilterPanel(self)
  end
